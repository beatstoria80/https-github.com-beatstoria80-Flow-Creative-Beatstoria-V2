...
export const NanoBananaStudio: React.FC<NanoBananaStudioProps> = ({ isOpen, onClose, onApply, onStash, initialImage, isOnline = true }) => {
  ...
  const startUpscale = async () => {
    if (!isOnline) {
      alert("ONLINE CONNECTION REQUIRED FOR NANO ENGINE");
      return;
    }
