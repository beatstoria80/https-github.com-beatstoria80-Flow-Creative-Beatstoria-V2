...
export const EditorControls: React.FC<EditorControlsProps> = React.memo(({
    ...
    return (
        <div className="h-full flex flex-col bg-white overflow-hidden relative">
            <div className="h-14 flex items-center justify-between px-5 border-b border-slate-100 shrink-0 bg-white z-[60]">
                    ...
                    <MySectionHeader
                        ...
                        actions={activeSection === 'layers' && (
                            <div className="flex items-center gap-1 mr-2" onClick={e => e.stopPropagation()}>
                                ...
                                <button onClick={onUngroup} disabled={!selectedIds.some(id => id.startsWith('group-') || config.groups.some(g => g.layerIds.includes(id)))} className="p-1 bg-slate-800 text-white rounded hover:bg-indigo-600 transition-colors disabled:opacity-30" title="Ungroup"><FolderMinus size={10} /></button>
